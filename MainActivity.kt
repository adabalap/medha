...
class MainActivity : AppCompatActivity() {
     ...
     *
     * NOT named onStart(): that collides with Activity.onStart(), and marking it
     * `override` would be worse than the compile error it silences — the service
     * would then launch every time the activity becomes visible, including on
     * return from the SAF file picker and the battery-optimisation screen.
     */
